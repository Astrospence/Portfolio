    ...
    return (
        <div className='me'>
            ...
            <div className='bio'>
                ...
                <p>I've graduated from BloomTech with a certification in Full-Stack Web Developing. I'm confident in the skills and knowledge I've gained, but I'm humbled and excited and eager to join the workforce and let my inner scholar take off.</p>
            </div>
        </div>
    )
}