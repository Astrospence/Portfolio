        ...
        <div className='projects'>
            ...
            <div className='project1'>
                ...
                <div className='description'>
                    ...
                    <p>This website you're viewing is a personal project as well as a portfolio to house a more comprehensive view of my journey and my projects. I used <span style={{'fontWeight':'bold', 'color':'white'}}>React.js, CSS, HTML, and JavaScript</span> to put it all together. In the interest of expansion and scaling, I implemented <span style={{'fontWeight':'bold', 'color':'white'}}>React Router</span> for client-side routing. If you'd like to take a look at my GitHub repo of this project, you can click <a href={'https://github.com/Astrospence/Portfolio/tree/main/portfolio'} target={'_blank'} rel={'noreferrer'}><span style={{'fontWeight':'bold','color':'lightgreen'}}>here</span></a>.</p>
                </div>
            </div>
